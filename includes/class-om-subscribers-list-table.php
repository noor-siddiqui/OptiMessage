	...
	public function column_default( $item, $column_name ) {
		...
		switch ( $column_name ) {
			...
			case 'valid_phone':
				...
				if ( function_exists( 'as_has_scheduled_action' ) && ! as_has_scheduled_action( 'om_async_twilio_user_lookup_job', array( $item->ID ) ) ) {
					as_enqueue_async_action( 'om_async_twilio_user_lookup_job', array( $item->ID ) );
				} elseif ( ! function_exists( 'as_has_scheduled_action' ) && ! wp_next_scheduled( 'om_async_twilio_user_lookup_job', array( $item->ID ) ) ) {
